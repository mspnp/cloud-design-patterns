...
![Figure 1 - Customer information organized by the primary key (Customer ID)](media/index-table-figure-1.png)
...
![Figure 2 - Data is duplicated in each index table](media/index-table-figure-2.png)
...
![Figure 3 - Data is referenced by each index table](media/index-table-figure-3.png)
...
![Figure 4 - Commonly accessed data is duplicated in each index table](media/index-table-figure-4.png)
...
![Figure 5 - An index table based on composite keys](media/index-table-figure-5.png)
...
![Figure 6 - An index table providing quick lookup for sharded data](media/index-table-figure-6.png)
...
![Figure 7 - Movie data stored in an Azure table](media/index-table-figure-7.png)
...
![Figure 8 - Actor partitions acting as index tables for movie data](media/index-table-figure-8.png)
